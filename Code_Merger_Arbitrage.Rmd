...
library(huxtable)
library(Hmisc)
library(googlesheets4) # load google sheets
library(psych) # proper geometric mean :D if needed
library(quantmod)
```
...
# Alternative: 
# stocks2 <- read_sheet("https://docs.google.com/spreadsheets/d/1-IxOKy5UK85RDXVNfi7hHH16PN9bKbeodu7bToxwhss/edit?usp=sharing", sheet = "Sheet1") %>% 
