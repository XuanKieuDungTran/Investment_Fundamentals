...
library(huxtable)
library(Hmisc)
library(psych) # allows proper geometric mean :D
library(quantmod)
library(googlesheets4) # load from google sheets
```
...
# stocks2 <- read_sheet("https://docs.google.com/spreadsheets/d/1-IxOKy5UK85RDXVNfi7hHH16PN9bKbeodu7bToxwhss/edit?usp=sharing", sheet = "Sheet1") %>% alternative
